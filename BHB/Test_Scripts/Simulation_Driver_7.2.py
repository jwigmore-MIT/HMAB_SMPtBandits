...
from Test_Scenarios_7_2 import Basic_5
...
Est2 = KnownVarianceEstimator(Env, Settings)
Pol2 = Tiered_HTS(Est2, name = 'Tiered HTS - Known Prior')
...
Pol4 = Full_HTS(Est4, name = 'Full HTS - Known_Prior', sample_all= False)


Est5 = KnownVarianceEstimator(Env, est_priors)
Pol5 = Full_HTS(Est5, name = "Full HTS - Uninformative Priors")
