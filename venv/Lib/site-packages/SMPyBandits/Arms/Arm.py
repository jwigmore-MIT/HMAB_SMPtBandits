...
class Arm(object):
    ...
    def lower_amplitude(self):
        ...
        if hasattr(self, 'lower') and hasattr(self, 'amplitude'):
            ...
            raise NotImplementedError("This method lower_amplitude() has to be implemented in the class inheriting from ArmBelief.")
    ...
    def draw(self, t=None):
        ...
        raise NotImplementedError("This method draw(t) has to be implemented in the class inheriting from ArmBelief.")

    def draw_nparray(self, shape=(1,)):
        """ Draw a numpy array of random samples, of a certain shape."""
        raise NotImplementedError("This method draw_nparray(t) has to be implemented in the class inheriting from ArmBelief.")
    ...
    def kl(x, y):
        ...
        raise NotImplementedError("This method kl(x, y) has to be implemented in the class inheriting from ArmBelief.")

    @staticmethod
    def oneLR(mumax, mu):
        """ One term of the Lai & Robbins lower bound for Gaussian arms: (mumax - mu) / KL(mu, mumax). """
        raise NotImplementedError("This method oneLR(mumax, mu) has to be implemented in the class inheriting from ArmBelief.")
