# -*- coding: utf-8 -*-
r""" The AdSwitchNew policy for non-stationary bandits, from [["Adaptively Tracking the Best ArmBelief with an Unknown Number of Distribution Changes". Peter Auer, Pratik Gajane and Ronald Ortner, 2019]](http://proceedings.mlr.press/v99/auer19a/auer19a.pdf)
...
class AdSwitchNew(BasePolicy):
    ...
    def choice(self):
        ...
        for arm in self.set_GOOD | {a for a in range(self.nbArms) if self.set_S[a]}:
            ...
            print("\nAdSwitchNew: for arm = {}, this time tau_i = {}, and t = {}, look ahead in past (t - min t') = {}.".format(arm, these_times_taus[arm], self.t, look_ahead_in_past))  # DEBUG
