...
class ETC_FixedBudget(EpsilonGreedy):
    ...
    def __init__(self, nbArms, horizon=None, gap=GAP,
        ...
        self.best_identified_arm = None  #: ArmBelief on which we commit, not defined in the beginning.
...
class ETC_BAI(_ETC_RoundRobin_WithStoppingCriteria):
    r""" The Best ArmBelief Identification variant of the Explore-Then-Commit policy, with known horizon :math:`T`.
