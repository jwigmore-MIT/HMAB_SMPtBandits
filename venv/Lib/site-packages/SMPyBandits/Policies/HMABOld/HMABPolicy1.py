...
class HMABPolicy1(HMABBasePolicy):
    """
    First Algorithm where Band is chosen based off the likelihood distribution with parameters equal to the MLE of the prior/previous posterior
    Bin selection is then UCB
    Probably (Definitely) flawed
    """
    # def __init__(self):
    ...
    def choice(self, verbose = True): # This is where I finally implement the algorithm
        ...
        def chooseBin(Band): # Based off UCB
