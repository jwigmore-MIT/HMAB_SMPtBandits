...
"""
See notes (obsidian://open?vault=Research&file=Implementation%2FImplementation%20Kanban%20Notes%2FBandThenBin%20(2)%20Algorithm%20Implementation)
For Details

Only works for Uniform distribution
"""
class BandThenBin2(HMABPolicy):
    ...
    def __init__(self,nbBands, nbBins, posterior, priorParams, verbose = True, precountMax = None):
        ...
        if precountMax is None:
            self.precountMax = nbBins/2  # Sample each bin once
        self.precount = 0
    ...
    def choice(self):
        ...
        def chooseBin(Band):
            ...
            return Bin
        if self.stage == "Pre":
            choice = self.precount%self.nbArms
            self.precount +=1
