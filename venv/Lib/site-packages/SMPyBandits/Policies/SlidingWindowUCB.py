...
class SWUCB(IndexPolicy):
    ...
    def __init__(self, nbArms,
        ...
        # New parameters
        assert 1 <= tau, "Error: parameter 'tau_i' for class SWUCB has to be >= 1, but was {}.".format(tau)  # DEBUG
        self.tau = int(tau)  #: Size :math:`\tau_i` of the sliding window.
        ...
        # Internal memory
        self.last_rewards = np.zeros(tau)  #: Keep in memory all the rewards obtained in the last :math:`\tau_i` steps.
