...
#: Default value for the parameter :math:`\tau_i \geq 1` that is used to artificially increase the horizon, from :math:`T` to :math`\tau_i T`.
...
class ApproximatedFHGittins(IndexPolicy):
    ...
    def __init__(self, nbArms, horizon=None,
        ...
        self.distortion_horizon = distortion_horizon  #: Parameter :math:`\tau_i > 0`.
