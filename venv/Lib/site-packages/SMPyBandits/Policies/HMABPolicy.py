...
class HMABPolicy(BasePolicy):
    def __init__(self, nbBands, nbBins, posterior = NormalGamma, priorParams = None, verbose = True):
        """
    ...
    def computeArmIndex(self, Band, Bin):  # Compute the arm index (i.e. Upper Conf. Bounds) for Arm(Band,Bin)
